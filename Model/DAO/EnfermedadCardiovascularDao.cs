...
public async Task<ResultOperation<List<VMCatalog>>> GetAllperson()
        {
            ...
            Task<RespuestaBD> respuestaBDTask = _sqlTools.ExecuteFunctionAsync("admece.fn_getallperson_enfermedad_cardiovascular"
                );
            RespuestaBD respuestaBD = await respuestaBDTask;
            resultOperation.Success = !respuestaBD.ExisteError;
            if (!respuestaBD.ExisteError)
        ...
        public async Task<ResultOperation<int>> AddAsync([FromBody] EnfermedadCardiovascular enfermedad)
        {
            ...
            try
            {
                ...
                Task<RespuestaBD> respuestaBDTask = _sqlTools.ExecuteFunctionAsync(
                    "admece.fn_add_enfermedad",
                    new ParameterPGsql[]
                    {
                new ParameterPGsql("e_id_enf_cardiovascular", NpgsqlTypes.NpgsqlDbType.Integer, enfermedad.id_enf_cardiovascular),
        ...
        public async Task<ResultOperation<VMCatalog>> UpdAsync(EnfermedadCardiovascular enfermedad, int id)
        {
            ResultOperation<VMCatalog> resultOperation = new ResultOperation<VMCatalog>();
            enfermedad.id_enf_cardiovascular = id;

            Task<RespuestaBD> respuestaBDTask = _sqlTools.ExecuteFunctionAsync(
                "admece.fn_update_enfermedad_cardiovascular",
                new ParameterPGsql[]
                {
                new ParameterPGsql("p_id_enf_cardiovascular", NpgsqlTypes.NpgsqlDbType.Integer, id),
        ...
        public async Task<ResultOperation<VMCatalog>> DeleteAsync(int id)
        {
            ...
            Task<RespuestaBD> respuestaBDTask = _sqlTools.ExecuteFunctionAsync(
                "admece.fn_delete_enfermedad_cardiovascular", 
                new ParameterPGsql[]
                {
                new ParameterPGsql("p_id_enf_cardiovascular", NpgsqlTypes.NpgsqlDbType.Integer, id)
                }
